...
:math:`\textcolor{green}{\pi^{UnusedTreatedWater}}` =      Cost of unused treated water
...
**Unused Treated Water Cost:** :math:`\forall \textcolor{blue}{r \in R}, \textcolor{blue}{t \in T}`

For each treatment site, for each time period, the unused treated water cost is equal to all water not used after treating multiplied by the unused treated water cost. The total unused treated water cost is the sum of unused treated water costs over all time periods and all treatment sites.
