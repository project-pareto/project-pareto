...
:math:`\textcolor{green}{τ^{DaysInPeriod}}` =                      Number of days in one time period
...
.. math::
    ...
    \textcolor{red}{L_{p,t}^{PadStorage}} = \textcolor{green}{λ_{p,t=1}^{PadStorage}}+\textcolor{red}{L_{p,t-1}^{PadStorage}}

        +\textcolor{green}{τ^{DaysInPeriod}}⋅(\textcolor{red}{F_{p,t}^{StorageIn}}-\textcolor{red}{F_{p,t}^{StorageOut}})
...
.. math::
    ...
    \textcolor{red}{L_{s,t}^{Storage}} = \textcolor{green}{λ_{s,t=1}^{Storage}}+ \textcolor{red}{L_{s,t-1}^{Storage}}+ \textcolor{green}{τ^{DaysInPeriod}}⋅(∑_{(n,s)∈NSA}\textcolor{red}{F_{l,l,t}^{Piped}}+∑_{(r,s)∈RSA}\textcolor{red}{F_{l,l,t}^{Piped}}

        +∑_{(p,s)∈PST}\textcolor{red}{F_{l,l,t}^{Trucked}} +∑_{(p,s)∈CST}\textcolor{red}{F_{l,l,t}^{Trucked}}-∑_{(s,n)∈SNA}\textcolor{red}{F_{l,l,t}^{Piped}}

        -∑_{(s,p)∈SCA}\textcolor{red}{F_{l,l,t}^{Piped}}-∑_{(s,k)∈SKA}\textcolor{red}{F_{l,l,t}^{Piped}} -∑_{(s,r)∈SRA}\textcolor{red}{F_{l,l,t}^{Piped}}

        -∑_{(s,o)∈SOA}\textcolor{red}{F_{l,l,t}^{Piped}}-∑_{(s,p)∈SCT}\textcolor{red}{F_{l,l,t}^{Trucked}}-∑_{(s,k)∈SKT}\textcolor{red}{F_{l,l,t}^{Trucked}})
...
.. math::
    ...
    \textcolor{red}{C_{f,p,t}^{Sourced}} =\textcolor{green}{τ^{DaysInPeriod}}⋅(\textcolor{red}{F_{f,p,t}^{Sourced}}+\textcolor{red}{F_{f,p,t}^{Trucked}})⋅\textcolor{green}{π_{f}^{Sourcing}}
...
.. math::
    ...
    \textcolor{red}{F^{TotalSourced}} = \textcolor{green}{τ^{DaysInPeriod}}⋅∑_{∀t∈T}∑_{f∈F}∑_{p∈CP}(\textcolor{red}{F_{f,p,t}^{Sourced}}+\textcolor{red}{F_{f,p,t}^{Trucked}})
...
.. math::
       ...
       \textcolor{red}{C_{k,t}^{Disposal}} = \textcolor{green}{τ^{DaysInPeriod}}⋅(∑_{(l,k)∈{NKA,RKA,SKA}}\textcolor{red}{F_{l,l,t}^{Piped}}

            +∑_{(l,k)∈{PKT,CKT,SKT,RKT}}\textcolor{red}{F_{l,l,t}^{Trucked}})⋅ \textcolor{green}{π_{k}^{Disposal}}
...
.. math::
    ...
    \textcolor{red}{F^{TotalDisposed}} = \textcolor{green}{τ^{DaysInPeriod}}⋅∑_{∀t∈T}

        (∑_{(l,l)∈{NKA,RKA,SKA}}\textcolor{red}{F_{l,l,t}^{Piped}} +∑_{(l,l)∈{PKT,CKT,SKT,RKT}}\textcolor{red}{F_{l,l,t}^{Trucked}})
...
.. math::
    ...
    \textcolor{red}{C_{r,t}^{Treatment}} = \textcolor{green}{τ^{DaysInPeriod}}⋅(∑_{(l,l)∈{NRA,SRA}}\textcolor{red}{F_{l,l,t}^{Piped}}+∑_{(l,l)∈{PRT,CRT}}\textcolor{red}{F_{l,l,t}^{Trucked}})⋅ \textcolor{green}{π_{r}^{Treatment}}
...
.. math::
    ...
    \textcolor{red}{C_{p,t}^{CompletionsReuse}} = \textcolor{green}{τ^{DaysInPeriod}}⋅(∑_{(n,p)∈NCA}\textcolor{red}{F_{l,l,t}^{Piped}}+∑_{(p,p)∈PCA}\textcolor{red}{F_{l,l,t}^{Piped}}+∑_{(r,p)∈RCA}\textcolor{red}{F_{l,l,t}^{Piped}}
...
.. math::
    ...
    \textcolor{red}{F^{TotalCompletionsReused}} = \textcolor{green}{τ^{DaysInPeriod}}⋅∑_{∀t∈T}(∑_{(n,p)∈NCA}\textcolor{red}{F_{l,l,t}^{Piped}} +∑_{(p,p)∈PCA}\textcolor{red}{F_{l,l,t}^{Piped}}
...
.. math::
    ...
    \textcolor{red}{C_{l,l,t}^{Piped}} = \textcolor{green}{τ^{DaysInPeriod}}⋅(\textcolor{red}{F_{l,l,t}^{Piped}}+\textcolor{red}{F_{l,l,t}^{Sourced}})⋅ \textcolor{green}{π_{l,l}^{Pipeline}}
...
.. math::
    ...
    \textcolor{red}{C_{s,t}^{Storage}} = \textcolor{green}{τ^{DaysInPeriod}}⋅(∑_{(l,s)∈{NSA}}\textcolor{red}{F_{l,s,t}^{Piped}} +∑_{(l,s)∈{RSA}}\textcolor{red}{F_{l,s,t}^{Piped}}
...
.. math::
    ...
    \textcolor{red}{R_{s,t}^{Storage}} = \textcolor{green}{τ^{DaysInPeriod}}⋅(∑_{(s,l)∈{SNA,SCA,SKA,SRA,SOA}}\textcolor{red}{F_{s,l,t}^{Piped}}+∑_{(s,l)∈{SCT,SKT}}\textcolor{red}{F_{s,l,t}^{Trucked}})⋅ \textcolor{green}{ρ_{s}^{Storage}}
...
.. math::
    ...
    \textcolor{red}{C_{l,l ̃  ,t}^{Trucked}} = \textcolor{green}{τ^{DaysInPeriod}}⋅\textcolor{red}{F_{l,l ̃,t}^{Trucked}}⋅\textcolor{green}{1⁄δ^{Truck}} ⋅\textcolor{green}{τ_{l,l ̃}^{Trucking}}⋅\textcolor{green}{π_{l}^{Trucking}}
...
.. math::
    ...
    \textcolor{red}{F^{TotalTrucking}} = \textcolor{green}{τ^{DaysInPeriod}}⋅(∑_{∀t∈T}∑_{∀(l,l)∈{PPA,…,CCT}}\textcolor{red}{F_{l,l ̃  ,t}^{Trucked}})
