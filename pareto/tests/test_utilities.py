...
def test_data_check():
    ...
    assert (
        "The following parameters were missing and default values were substituted:['Economics', 'ComponentPrice', 'ComponentTreatment', 'MinTreatmentFlow', 'MinResidualQuality', 'DesalinationSurrogate']"
