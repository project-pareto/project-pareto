...
def test_hydraulics_post_process_input(
    ...
    assert isinstance(mh.hydraulics.p_PumpFixedCost, pyo.Param)
    assert isinstance(mh.hydraulics.p_ElectricityCost, pyo.Param)
    assert isinstance(mh.hydraulics.p_PumpEfficiency, pyo.Param)
    assert isinstance(mh.hydraulics.p_MotorEfficiency, pyo.Param)
    assert isinstance(mh.hydraulics.p_WellPressure, pyo.Param)
    assert isinstance(mh.hydraulics.p_effective_Pipeline_diameter, pyo.Param)
    assert isinstance(mh.hydraulics.p_Min_AOP, pyo.Param)
    assert isinstance(mh.hydraulics.p_Max_AOP, pyo.Param)
