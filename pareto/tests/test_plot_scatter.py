...
def input_data_animated_1():
    set_list = []
    parameter_list = ["test_plot_scatter_y", "test_plot_scatter_x", "test_plot_scatter_y_static", "test_plot_scatter_x_static", "test_plot_scatter_size", 
        "plot_scatter_vFPiped", "plot_scatter_vCPiped", "plot_scatter_vSize", "plot_scatter_Categories", "plot_scatter_static_Categories", "test_plot_scatter_size_static"]

    with resources.path("pareto.case_studies", "visualization_test_data.xlsx") as fpath:
        [df_sets, df_parameters] = get_data(fpath, set_list, parameter_list)

    return {"pareto_var_x": df_parameters["plot_scatter_vFPiped"],
            "pareto_var_y": df_parameters["plot_scatter_vCPiped"],
            "size": df_parameters["plot_scatter_vSize"], #'x/y', 'y/x', df_parameters["test_plot_scatter_y"]
...
def input_data_static_1():
    ...
    return {"pareto_var_x": df_parameters["test_plot_scatter_x_static"],
            "pareto_var_y": df_parameters["test_plot_scatter_y_static"],
            "size": df_parameters["test_plot_scatter_size_static"], #'x/y', 'y/x', df_parameters["test_plot_scatter_y"]
...
@pytest.fixture(scope="module")
def plot_args1():
    return {"plot_title": "Test Data", "group_by": "Destination", "output_file": "first_scatter.html", "print_data": True, "group_by_category": True} # 'jpg', 'jpeg', 'pdf', 'png', 'svg', 'html'

@pytest.fixture(scope="module")
def plot_args2():
    return {"plot_title": "Test Data", "group_by": "Destination", "output_file": "first_scatter.html", "print_data": True, "group_by_category": False} # 'jpg', 'jpeg', 'pdf', 'png', 'svg', 'html'

@pytest.fixture(scope="module")
def plot_args3():
    return {"plot_title": "Test Data", "group_by": "Origin", "output_file": "first_scatter.html", "print_data": True, "group_by_category": False} # 'jpg', 'jpeg', 'pdf', 'png', 'svg', 'html'

@pytest.fixture(scope="module")
def plot_args4():
    return {"plot_title": "Test Data", "group_by": "Origin", "output_file": "first_scatter.html", "print_data": True, "group_by_category": True} # 'jpg', 'jpeg', 'pdf', 'png', 'svg', 'html'
...
def plot_args5():
    ...
    with resources.path("pareto.case_studies", "visualization_test_data.xlsx") as fpath:
        [df_sets, df_parameters] = get_data(fpath, set_list, parameter_list)
    return {"plot_title": "Test Data", "group_by": "Origin", "output_file": "first_scatter.html", "print_data": True, "group_by_category": df_parameters['plot_scatter_Categories']} # 'jpg', 'jpeg', 'pdf', 'png', 'svg', 'html'
...
def plot_args5_static():
    ...
    with resources.path("pareto.case_studies", "visualization_test_data.xlsx") as fpath:
        [df_sets, df_parameters] = get_data(fpath, set_list, parameter_list)
    return {"plot_title": "Test Data", "group_by": "Origin", "output_file": "first_scatter.html", "print_data": True, "group_by_category": df_parameters['plot_scatter_static_Categories']} # 'jpg', 'jpeg', 'pdf', 'png', 'svg', 'html'
