...
#        if var_value != None and var_value > 0:
    ...
    solution_dict = {'Overview': v_F_Overview_dict, 'v_F_Piped': v_F_Pipe_dict, 
                    ...
                    'v_F_PadStorageOut': v_F_PadStorageOut_dict, 'v_F_ReuseDestination': v_F_ReuseDestination_dict,
                    'v_F_DisposalDestination': v_F_DisposalDestination_dict, 'v_C_Piped': v_C_Piped_dict,
