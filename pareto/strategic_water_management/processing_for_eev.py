# This code is created to evaluate the expected value of the stochastic model
# with the given scenrios. It first solves the expected-value (EV) problem by
# averaging the parameters across scenarios, then extracts the first-stage decisions
# from the EV solution, and finally solves the stochastic model with these
# first-stage decisions fixed to compute the expected EV (EEV).
