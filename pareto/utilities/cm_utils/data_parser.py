...
def data_parser(df_sets, df_parameters):
    ...
    d['p_betaR'] = {d['NT_set'][n][1]: df_parameters['BeneficialReuseCost'][n] for n in d['s_NT']}
    ...
    d['p_gammaR'] = {d['NT_set'][n][1]: df_parameters['BeneficialReuseRevenue'][n] for n in d['s_NT']}
